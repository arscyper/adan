...
function Ta(e, t, n) {
    e: {
        for (var r = e.length, i = m(e) ? e.split("") : e, s = 0; s < r; s++)
...
function ic(e) {
    ...
    for (e = e.parentNode; e && e != t; e = e.parentNode)
        if (n = gc(e, "position"), r = r && "static" == n && e != t.documentElement && e != t.body, !r && (e.scrollWidth > e.clientWidth || e.scrollHeight > e.clientHeight || "fixed" == n || "absolute" == n || "relative" == n)) return e;
    return null
}
...
function $c(e, t, n, r, i) {
    if (ka(t))
        for (var s = 0; s < t.length; s++) $c(e, t[s], n, r, i);
...
function nd(e, t, n, r) {
    ...
    o = !0;
    if ("[object Array]" == i) {
        if (s = e.length, o = s == t.length)
            for (; s-- && (o = nd(e[s], t[s], n, r)););
    } else {
        for (var u in e)
            if (hasOwnProperty.call(e, u) && (s++, !(o = hasOwnProperty.call(t, u) && nd(e[u], t[u], n, r)))) break;
        if (o) {
            for (u in t)
                if (hasOwnProperty.call(t, u) && !(s--)) break;
            o = !s
        }
    }
    n.pop();
...
function Vd(e) {
    if (!e.p && (e.p = new Ad, e.s = 0, e.V))
        for (var t = e.V.split("&"), n = 0; n < t.length; n++) {
            var r = t[n].indexOf("="),
                i = null,
                s = null;
...
function Jf(e) {
    if (e.ua && "undefined" != typeof ca)
        if (e.pd[1] && 4 == Kf(e) && 2 == Lf(e)) wf(e.X, Df(e, "Local request error detected and ignored"));
...
function Qf(e, t, r) {
    ...
    try {
        this.Xb && (this.m = new Ke, O(this.m, "navigate", this.$b, !1, this), Me(this.m), this.m.cc = "/" + this.Xb, this.m.Fa(!0)), s(this.aa, this.Ce, this), (new Hammer(this.Ue)).on("tap", function(e) {
...
function Rf(e, t) {
    /*Cf("/schedule/session/" + t + "", function(n) {
        var r = n.target;
        n = Nf(r);
...
/*function Eg(e) {
    ...
    if (e.ub && e.ub.length) {
        ...
        n = e.ub;
        r = n.length;
        for (i = 0; i < r; i++) s = n[i], t += '<div class="col -width-1-3"><a class="detail__extra-content js-pane-forward-external js-related-video" href="/schedule/' + Y(s.key) + '"><div class="details__content-image g-bg-grey" style="background-image:url(\'//img.youtube.com/vi/' + Y(String(s.video_id).replace(wg, xg)) + '/hqdefault.jpg\')">&nbsp;</div><p class="details__content-title -bold">' + W(s.title) + '</p><p class="details__content-description">' + W(s.description) + "</p></a></div>";
        t += "</div></div>"
    }
...
function ih(e, t, n, r) {
    if (e.gg || t != oh(e))
        if (e.gg = !1, t = encodeURIComponent(String(t)), y) {
...
function get_location() {
    var loc = document.getElementById("default-location").getAttribute("content");
    var loc_l = loc.split(",");
    if (Modernizr.geolocation) {
        navigator.geolocation.getCurrentPosition(function(e){
            var t = e.coords.latitude;
            var n = e.coords.longitude;
            insertParam(t, n, loc_l)
        }, function(e){
        	if(e.code == 1){
            	insertParam(null, null, loc_l);
        	}
        })
    } else {
...
function insertParam1(t, n){
	window.location.href = "/schedule/location/@"+ t + "," + n;// + "/" + atob(t[0]) + ","+ atob(t[1]) + "," + atob(t[2]); 
}

function insertParam(m,n,t) {
    var url;
    if(m != null && n != null && m.length > 0 && n > 0){
        url = "@" + m + "," + n;
    }else{
        url = "@" + t[3] + "," + t[4];
    }
	...
	window.location.href = "/schedule/location/" + url + b;
}(function(e) {
    "use strict";
...
(function(e) {
    ...
    function X(e) {
        var t, n, r = e._i,
            i = Xt.exec(r);
        if (i) {
            for (e._pf.iso = !0, t = 0, n = $t.length; n > t; t++)
                if ($t[t][1].exec(r)) {
                    e._f = $t[t][0] + (i[6] || " ");
                    break
                }
    ...
    for (nn.DDDD = r(nn.DDD, 3), a(s.prototype, {
                ...
                monthsParse: function(e) {
                    ...
                    for (this._monthsParse || (this._monthsParse = []), t = 0; 12 > t; t++)
                        if (this._monthsParse[t] || (n = at.utc([2e3, t]), r = "^" + this.months(n, "") + "|^" + this.monthsShort(n, ""), this._monthsParse[t] = new RegExp(r.replace(".", ""), "i")), this._monthsParse[t].test(e)) return t
                },
                ...
                weekdaysParse: function(e) {
                    ...
                    for (this._weekdaysParse || (this._weekdaysParse = []), t = 0; 7 > t; t++)
                        if (this._weekdaysParse[t] || (n = at([2e3, 1]).day(t), r = "^" + this.weekdays(n, "") + "|^" + this.weekdaysShort(n, "") + "|^" + this.weekdaysMin(n, ""), this._weekdaysParse[t] = new RegExp(r.replace(".", ""), "i")), this._weekdaysParse[t].test(e)) return t
                },
                _longDateFormat: {
                    LT: "h:mm A",
                    L: "MM/DD/YYYY",
...
(function(e, t) {
    ...
    return function(r) {
        ...
        var h, p, d, v, m = {}, g = {}, y = {}, b = {}, w = Object.prototype.hasOwnProperty,
            E = [].slice,
            S = /\.js$/;
        d = function(e, t) {
            var n, r = l(e),
            ...
            if (w === "undefined" || w === "function") {
                ...
                if (e)
                    if (u && u.exports !== r && u.exports !== m[e]) m[e] = u.exports;
                    else if (c !== r || !E) m[e] = c
            } else e && (m[e] = n)
            ...
            return t = t || function() {}, typeof n == "function" && (n = i, i = s), i ? h(r, e, t, n) : setTimeout(function() {
                h(r, e, t, n)
            }, 4), p
        }, p.config = function(e) {
            return p(e)
        ...
        var r = [],
            i = window.addEventListener || function(e, t) {
                var n = this;
                r.unshift([n, e, t,
                        function(e) {
            ...
            }, s = window.removeEventListener || function(e, t) {
                for (var n = 0, i; i = r[n]; ++n)
                    if (i[0] == this && i[1] == e && i[2] == t) return this.detachEvent("on" + e, r.splice(n, 1)[0][3])
            }, o = window.dispatchEvent || function(e) {
        ...
        var Y = W(function(e, t) {
            if (e.closed) return;
            if (e.subscribers)
                for (var n = 0; n < e.subscribers.length; n++) e.subscribers[n](t);
            L(e.values, t)
        });
        ...
        var a = "2.7.2",
            ...
            N, C = function(e, t, n, r) {
                ...
                if (parseInt(n, 10))
                    while (n--) o = document.createElement("div"), o.id = r ? r[n] : c + (n + 1), a.appendChild(o);
        ...
        f.addTest = function(e, t) {
            if (typeof e == "object")
                for (var n in e) O(e, n) && f.addTest(n, e[n]);
            else {
                e = e.toLowerCase();
...
var r = Array.prototype,
    Oa = r.indexOf ? function(e, t, n) {
        ...
        return i
    }, Ra = r.some ? function(e, t, n) {
        return r.some.call(e, t, n)
    } : function(e, t, n) {
        for (var r = e.length, i = m(e) ? e.split("") : e, s = 0; s < r; s++)
            if (s in i && t.call(n, i[s], s, e)) return !0;
        return !1
    }, Sa = r.every ? function(e, t, n) {
        return r.every.call(e, t, n)
    } : function(e, t, n) {
        for (var r = e.length, i = m(e) ? e.split("") : e, s = 0; s < r; s++)
            if (s in i && !t.call(n, i[s], s, e)) return !1;
        return !0
    };
var $a, ab = {};
var eb, fb, gb, hb;
...
g.ma = function() {
    Vd(this);
    for (var e = this.p.na(), t = this.p.ma(), n = [], r = 0; r < t.length; r++)
...
g.toString = function() {
    ...
    if (!this.p) return "";
    for (var e = [], t = this.p.ma(), n = 0; n < t.length; n++)
        for (var r = t[n], i = encodeURIComponent(String(r)), r = this.na(r), s = 0; s < r.length; s++) {
            var o = i;
...
ke.prototype.send = function(e, t, n, r) {
    ...
    var i = this.Ci.clone();
    if (e)
        for (var s in e) e.hasOwnProperty && !e.hasOwnProperty(s) || Sd(i, s, e[s]);
...
var pe = function() {
    ...
    function t(e) {
        ...
        if (y && N) {
            ...
            for (e[0] && (e[0]._zipIdx = I), r = 1; i = e[r]; r++) e[r]._zipIdx != I && t.push(i), i._zipIdx = I;
        return t
    }
    ...
    var x = z && "BackCompat" == document.compatMode,
        ...
        }, P = {}, H = {}, j = {}, F = !! document.querySelectorAll && (!z || A("526")),
        I = 0,
        q = y ? function(e) {
...
g.dispatchEvent = function(e) {
    ...
    var i = !0,
        s;
    if (t)
        for (var o = t.length - 1; !e.Da && 0 <= o; o--) s = e.currentTarget = t[o], i = Je(s, r, !0, e) && i;
    e.Da || (s = e.currentTarget = n, i = Je(s, r, !0, e) && i, e.Da || (i = Je(s, r, !1, e) && i));
    if (t)
        for (o = 0; !e.Da && o < t.length; o++) s = e.currentTarget = t[o], i = Je(s, r, !1, e) && i;
    return i
};
g.f = function() {
    S.d.f.call(this);
...
g.log = function(e, t, n) {
    if (e.value >= jf(this).value)
        for (e = this.fh(e, t, n), t = "log:" + e.Eh, l.console && (l.console.timeStamp ? l.console.timeStamp(t) : l.console.markTimeline && l.console.markTimeline(t)), l.msWriteProfilerMark && l.msWriteProfilerMark(t), t = this; t;) {
            n = t;
            var r = e;
            if (n.lf)
                for (var i = 0, s = void 0; s = n.lf[i]; i++) s(r);
            t = t.getParent()
    }
};
g.fh = function(e, t, n) {
...
Pf.prototype.mi = function() {
    ...
    t || (v(this.bi, "-hide"), w(this.ei, "-hide"), Cf("/schedule/session/" + this.pf + "/rate", function(e) {}, "POST", e.toString()), E("js-details").scrollTop = 0)
};
...
g.Oc = function(e, t, n, r, i) {
    if (ka(t))
        for (var s = 0; s < t.length; s++) this.Oc(e, t[s], n, r, i);
    else {
...
g.ve = function(e, t, n, r, i) {
    if (ka(t))
        for (var s = 0; s < t.length; s++) this.ve(e, t[s], n, r, i);
...
g.Ya = function() {
    ...
    if (!this.Va || fh)
        if (e = oh(this) || "", null == this.kb || e == this.kb) this.kb = null, e != this.ib && nh(this, e)
};
g.Vh = function() {
    this.t.stop();
    this.t.start()
...
g.refresh = function() {
    ...
    Cf("/schedule/live/json", n(function(e) {
                if (Mf(e.target)) {
                    var t = e.target,
                        n = Nf(t);
...
ei.prototype.Ld = function(e, t, n, r, i) {
    ...
    (function() {
        ...
        s.Dg.innerHTML = s.sd;
        s.uMore1.href = "/schedule/location/@" + i.jb.lat() + "," + i.jb.lng() + "/" + i.new_u;
...
ii.prototype.Ld = function(e, t, n, r, i) {
    ...
    if (a == -1) {
        this.Od.innerHTML = f[6] + " " + r[6] + "<br><span class=\"\">" + i.new_u + "</span>";
    } else {
        this.Od.innerHTML = f[a] + " " + r[a] + "<br><span class=\"\">" + i.new_u + "</span>";
    }
    this.uMore.href = "/schedule/location/@" + i.jb.lat() + "," + i.jb.lng() + "/" + i.new_u;
    ...
    if (null == e) this.Ae && console.log("obj is null. Ignoring");
        ...
        gapi.client.request({
                ...
                try {
                    var r;
                    e: {
                        if (null != e && "object" == typeof e && "starred_sessions" in e && Array.isArray(e.starred_sessions))
                            for (var i = 0; i < e.starred_sessions.length; i++) {
...
da("io.init", function(e) {
    ...
    if (navigator.userAgent.match(/MSIE 8\./)) v(document.body, "ie8"), Aj(e);
        ...
        "schedule" !== e && (t = C("js-paging"), s(t, function(e) {
                    var t = P(e, "hasResponsiveImages") ? function(e) {
                            e = C("js-lazy-init", e);
                            s(e, function(e) {
